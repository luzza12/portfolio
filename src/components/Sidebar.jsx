	...
	return (
		<div className='sidebar'>
			...
			<div className='sidebar-name'>
				Saiful <span>Nakeusa</span>
			</div>
			<div className='sidebar-identity'>Web Developer</div>
			<a href='!#'>
			...
			<figure className='sidebar-social-icons'>
				<a href='!#'>
					{' '}
					<img src={Facebook} alt='facebook' className='sidebar-icon' />{' '}
				</a>
				<a href='!#'>
					{' '}
			...
			<div className='sidebar-contact'>
				<div className='sidebar-item'>
					<a href='!#'>
						<img src={Github} alt='github' className='sidebar-icon' /> Github{' '}
					</a>
				</div>
